            ...
            foreach ($chunks as $chunk) { ?>
              <tr>
                ...
                <td><?php echo $chunk[2]; if ($chunk[3]=='ODM') {
                  ...
                  echo '<img class="imageCSS" width="5%" src="images/KANU.jpg">';
                  $countKanu++;
                }
                if ($chunk[3]=='CCM') {
                  echo '<img class="imageCSS" width="5%" src="images/chamachama.jpg">';
                  $countccm++;
                }
                ...
                if ($chunk[3]=='FORD Kenya') {
                  echo '<img class="imageCSS" width="5%" src="images/ford.jpg">';
                  $countFord++;
                }
                ...
                if ($chunk[3]=='Narc Kenya') {
                  echo '<img class="imageCSS" width=5"%" src="images/narc_kenya.jpg">';
                  $countNarc++;
                }
                ?></td>
